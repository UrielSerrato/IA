...
print(50 * '=')
print('Section: Training a perceptron model on the Archivo dataset')
print(50 * '-')
## AQUÍ VA A TOMAR LOS DATOS DEL PROGRAMA ANTERIOR ##
df = pd.read_csv('C:\\Users\hp\Desktop\Modificado\serrato_archivo.csv')
print(df.tail())

#############################################################################
print(50 * '=')
print('Plotting the Archivo data')
print(50 * '-')

#Asigna 1 a Masculino y -1 a Femenino
y = df.iloc[1:, 2].values
y = np.where(y == 'Femenino', 1, -1)
...
plt.scatter(X[y == 1, 0], X[y == 1, 1], color='red', marker='o', label='Femenino')
plt.scatter(X[y == -1, 0], X[y == -1, 1], color='blue', marker='x', label='Masculino')
